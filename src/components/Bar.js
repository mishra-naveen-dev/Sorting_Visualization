        ...
        <>
            <div className="bar">
                ...
                <div className="side back">
                    <div className="color-back back-color-bar" style={front_back_right_left}></div>
                </div>
                <div className="quantity-nav">
                    <div className="quantity-button quantity-up" style={quantity} onClick={increaseLength}>
                        +
                    </div>
                    <div className="quantity-button quantity-down" style={quantity} onClick={decreaseLength}>
                        -
                    </div>
                </div>
            </div>
